...
namespace JsAction.ext
{
    ...
    /// </summary>
    internal class DocsByReflection
    {
        /// <summary>
        ...
        public static XmlElement XMLFromMember(MethodInfo methodInfo)
        {
            ...
            foreach (ParameterInfo parameterInfo in methodInfo.GetParameters())
            {
                ...
                {
                    var idxStart = parameterInfo.ParameterType.FullName.IndexOf("[[") + 2;
                    var idxEnd = parameterInfo.ParameterType.FullName.IndexOf(",");
                    fullname = parameterInfo.ParameterType.FullName.Substring(0, parameterInfo.ParameterType.FullName.IndexOf("`1")) + "{";
                    fullname += string.Format("{0}}}", parameterInfo.ParameterType.FullName.Substring(idxStart, idxEnd - idxStart));
                }
                else
