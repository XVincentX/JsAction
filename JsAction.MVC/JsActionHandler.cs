...
namespace JsAction
{
    ...
    /// </summary>
    public class JsActionHandler : IJsActionHandler, IHttpHandler, IRouteHandler
    {
        /// <summary>
        ...
        protected override void GenerateMethodCall(StringBuilder js, MethodInfo method, string Controller, JsActionAttribute jsattribute, bool documentate)
        {
