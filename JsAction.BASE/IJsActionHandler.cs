    ...
    public abstract class IJsActionHandler : IHttpHandler, IRouteHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (context.Cache.Get(cacheKey) == null || documentate == true)
            {
                ...
                if (!documentate && InjectHelperScript)
                ...
                js.Append("if (typeof JsActions == 'undefined') {var JsActions={}; JsActions.WebApi={}; JsActions.JsQueryables={};}");
        ...
        protected abstract bool InjectHelperScript { get; }
        #endregion
